...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_width',                  'default': w, 'description': 'depth image width'},
                           {'name': 'depth_height',                 'default': h, 'description': 'depth image height'},
                           {'name': 'enable_depth',                 'default': 'true', 'description': 'enable depth stream'},
                           {'name': 'color_width',                  'default': w, 'description': 'color image width'},
                           {'name': 'color_height',                 'default': h, 'description': 'color image height'},
                           {'name': 'enable_color',                 'default': 'true', 'description': 'enable color stream'},
                           {'name': 'infra_width',                  'default': w, 'description': 'infra width'},
                           {'name': 'infra_height',                 'default': h, 'description': 'infra width'},
                           ...
                           {'name': 'fisheye_width',                'default': w, 'description': 'fisheye width'},
                           {'name': 'fisheye_height',               'default': h, 'description': 'fisheye width'},
                           {'name': 'enable_fisheye1',              'default': 'true', 'description': 'enable fisheye1 stream'},
                           {'name': 'enable_fisheye2',              'default': 'true', 'description': 'enable fisheye2 stream'},
                           {'name': 'confidence_width',             'default': w, 'description': 'depth image width'},
                           {'name': 'confidence_height',            'default': h, 'description': 'depth image height'},
                           ...
                           {'name': 'gyro_fps',                     'default': fps, 'description': ''},
                           {'name': 'accel_fps',                    'default': fps, 'description': ''},
